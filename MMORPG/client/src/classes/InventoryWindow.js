...
export default class InventoryWindow extends ModelWindow {
  ...
  createInnerWindowRectangle({
    ...
    if (this.rect) {
      ...
      // updte inventory container position
  ...
  updateInventoryContainerPositions() {
    ...
    for (let x = 0; x < 5; x += 1) {
      ...
      this.inventoryItems[x].defenceIcon.x = this.inventoryContainer.width * 0.65;
      ...
      this.inventoryItems[x].defenceIconText.x = this.inventoryContainer.width * 0.65 + 15;
  ...
  createInventoryItems() {
    for (let x = 0; x < 5; x += 1) {
      ...
      this.inventoryItems[x].defenceIcon = this.scene.add.image(0, yPos, 'inventoryShield').setScale(0.75);
      ...
      this.itemsContainer.add(this.inventoryItems[x].defenceIcon);
      ...
      this.inventoryItems[x].defenceIconText = this.scene.add.text(0, yPos - 10, '10', { fontSize: '14px', fill: '#00ff00' });
      ...
      this.itemsContainer.add(this.inventoryItems[x].defenceIconText);
  ...
  showWindow(playerObject, mainPlayer) {
    ...
    this.shieldStatText.setText(playerObject.defenceValue);
    this.goldStatText.setText(playerObject.gold);

    // hide invnetory not needed
  ...
  hideInventoryItem(itemNumber) {
    ...
    this.inventoryItems[itemNumber].defenceIcon.setAlpha(0);
    this.inventoryItems[itemNumber].defenceIconText.setAlpha(0);
  ...
  showInventoryItem(itemNumber) {
    ...
    this.inventoryItems[itemNumber].defenceIcon.setAlpha(1);
    this.inventoryItems[itemNumber].defenceIconText.setAlpha(1);
  ...
  updateInventoryItem(item, itemNumber) {
    ...
    this.inventoryItems[itemNumber].defenceIconText.setText(item.defenceBonus);
    ...
    if (item.defenceBonus > 0) {
      this.inventoryItems[itemNumber].defenceIconText.setFill('#00ff00');
    } else {
      this.inventoryItems[itemNumber].defenceIconText.setFill('#ff0000');
    }
